                  ...
                  <div className="grid grid-cols-4 gap-2 overflow-auto">
                    {product.images.map((image, index) => (
                      <button
                        ...
                        className={`h-16 w-full object-cover rounded border-2 ${
                          currentImage === index
                            ? "border-green-500"
                            : "border-gray-300"
                        }`}
              ...
              <div>
                ...
                <div className="flex space-x-4 mb-6">
                  <button
                    ...
                    className={`flex items-center justify-center px-4 py-2 border rounded-lg transition-colors whitespace-nowrap ${
                      isFavorite
